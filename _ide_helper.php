...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function mask($str, $first, $last, $mask = '*')
        {
     ...
     */ 
         ...
         * @static 
         */ 
        public static function datepicker($name, $defaultValue = null, $format = 'Y-m-d')
        {
                        /** @var \Laravolt\SemanticForm\SemanticForm $instance */
         ...
         * @static 
         */ 
        public static function datetimepicker($name, $defaultValue = null, $format = 'Y-m-d')
        {
                        /** @var \Laravolt\SemanticForm\SemanticForm $instance */
         ...
         * @static 
         */ 
        public static function tabular($name, $definition)
        {
                        /** @var \Laravolt\SemanticForm\SemanticForm $instance */
                        return $instance->tabular($name, $definition);
        }
                    /**
         * 
         *
     ...
     */ 
         ...
         * 
         *
         * @see \Laravolt\Platform\Providers\PlatformServiceProvider::bootPreset()
         * @param \Laravel\Ui\UiCommand $command
         * @static 
         */ 
        public static function laravolt($command)
        {
                        return \Illuminate\Console\Command::laravolt($command);
        }
...
namespace  { 
            ...
            class SemanticForm extends \Laravolt\SemanticForm\Facade {}
